...
public class RequestUtil {
    ...
    private static final String BASE_URI = getStringValue(CREDENTIALS.fileName, API_URL.key);
    private static final RequestSpecification requestSpecification = given().baseUri(BASE_URI);
