...
public class WebApiUtil {
    ...
    public static boolean hasCorrespondingElement(List<TestModel> nexageFirstPageTests, List<TestModel> apiResponseTests) {
    ...
    public static void sendScreenShotOfCurrentPageUsingApi(String testId, String content, String contentType){
